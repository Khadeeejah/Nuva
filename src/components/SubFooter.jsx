  ...
  return (
    <div className="px-4 text-sm pt-10 pb-16 md:px-10 lg:px-20 lg:py-20 lg:text-base xl:py-28 xl:px-[7.5rem]">
      <div>
        ...
        <button className="px-6 py-2.5 mx-auto flex mt-8 text-black-50 font-medium bg-primary-100 cursor-pointer rounded-lg transition duration-300 xl:hover:bg-primary-50">
          Stay Updated!
        </button>
      </div>
    </div>
