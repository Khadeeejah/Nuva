      ...
      <div className="flex flex-col gap-14 lg:flex-row xl:gap-24">
        ...
        <div className="grid gap-6 text-center text-neutral-100 lg:text-left lg:w-3/4 xl:text-lg">
          <p>
            ...
            <span className="text-primary-100 font-semibold">Blockchain technology </span>{" "}
            that provides a comprehensive and customisable technology platform
             to create an inclusive, efficient, and transparent insurance ecosystem while allowing 
             full control over data and compliance.

          </p>
          <p>
            We are Qatar&apos;s first insurance technology platform designed with Sharia compliance.
            We offer insurance companies full customisation and control over their data while equipping them with cutting-edge, 
          ...
          We&apos;re on a mission to transform insurance with blockchain and
            ...
            Insurance companies and SMEs to share risk and promotes financial inclusion for all.
          </p>
        </div>
      </div>
    </div>
